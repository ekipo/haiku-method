...
- The agent **MUST** verify that the right stakeholders for implementation kickoff are identified and named in the handoff packet (scheduling itself belongs to the receiving project-management or software stage, not sales)
