...
// auto-generated workflow lifecycle diagram. Reads
// website/public/workflow-diagrams/<studio>.mmd at build time and
// lists each studio with a link to its detail page.
//
// The .mmd files are regenerated by
// packages/haiku/scripts/export-workflow-diagrams.mjs from the
// StudioConfig. Whenever a studio's STAGE.md / hats / fix-hats /
// review-agents change, the diagrams regenerate (also wired into
...
export const metadata: Metadata = {
	...
	description:
		"Auto-generated state diagrams for every H·AI·K·U studio's lifecycle — derived from the StudioConfig.",
}
